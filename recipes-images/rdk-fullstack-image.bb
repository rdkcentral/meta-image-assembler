...
create_init_link() {
        ...
        sed -i 's/^SystemMaxUse=.*/SystemMaxUse=16M/' ${IMAGE_ROOTFS}/${sysconfdir}/systemd/journald.conf
        sed -i 's/^SystemMaxFileSize=.*/SystemMaxFileSize=8M/' ${IMAGE_ROOTFS}/${sysconfdir}/systemd/journald.conf
