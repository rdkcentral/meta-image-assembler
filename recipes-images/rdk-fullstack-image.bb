...
create_init_link() {
        ...
        sed -i 's/^RuntimeMaxFileSize=.*/RuntimeMaxFileSize=6M/' ${IMAGE_ROOTFS}/${sysconfdir}/systemd/journald.conf
        sed -i 's/^RuntimeMaxUse=.*/RuntimeMaxUse=6M/' ${IMAGE_ROOTFS}/${sysconfdir}/systemd/journald.conf 
}
